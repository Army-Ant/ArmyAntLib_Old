...
extern "C" {
	...
	DWORD AA_FILE_POS_END = 0xffffffff;
	...
	ARMYANT_CLIB_API DWORD AA_Stream_ReadSome(AA_CFileStream stream, void*buffer, DWORD len = 0, DWORD pos = AA_FILE_POS_END);
	ARMYANT_CLIB_API DWORD AA_Stream_ReadTo(AA_CFileStream stream, void*buffer, BYTE endtag);
	ARMYANT_CLIB_API DWORD AA_Stream_Write(AA_CFileStream stream, void*buffer, DWORD len = 0);

	ARMYANT_CLIB_API BOOL AA_Stream_CopyFile();
	ARMYANT_CLIB_API BOOL AA_Stream_MoveFile();
	ARMYANT_CLIB_API BOOL AA_Stream_RenameFile();
	ARMYANT_CLIB_API BOOL AA_Stream_DeleteFile();
	ARMYANT_CLIB_API BOOL AA_Stream_IsFileExist();
