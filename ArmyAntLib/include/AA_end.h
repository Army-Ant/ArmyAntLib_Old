...
#else // OS_WINDOWS
#include <dlfcn.h>
namespace ArmyAnt { static auto&armyAnt = []() { class ArmyAnt { public: ArmyAnt() { ptr = dlopen("libArmyAnt" AA_IS_DEBUG AA_TARGET_MACHINE AA_LIB_TYPE ".so", RTLD_NOW); } ~ArmyAnt() { dlclose(ptr); } void*ptr = nullptr; }; static ArmyAnt ret; return ret; }; }
#endif // OS_WINDOWS
