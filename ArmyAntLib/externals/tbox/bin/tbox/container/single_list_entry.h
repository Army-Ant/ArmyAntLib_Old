 ...
 */
static __tb_inline__ tb_single_list_entry_ref_t tb_single_list_entry_next(tb_single_list_entry_head_ref_t, tb_single_list_entry_ref_t entry)
{
    // check
    tb_assert(entry);
 ...
 */
static __tb_inline__ tb_single_list_entry_ref_t tb_single_list_entry_tail(tb_single_list_entry_head_ref_t)
{ 
    return tb_null;
}
