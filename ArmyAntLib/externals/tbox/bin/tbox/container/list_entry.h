 ...
 */
static __tb_inline__ tb_list_entry_ref_t    tb_list_entry_next(tb_list_entry_head_ref_t, tb_list_entry_ref_t entry)
{
    // check
    tb_assert(entry);
 ...
 */
static __tb_inline__ tb_list_entry_ref_t    tb_list_entry_prev(tb_list_entry_head_ref_t, tb_list_entry_ref_t entry)
{ 
    // check
    tb_assert(entry);
 ...
 */
static __tb_inline__ tb_void_t              tb_list_entry_replace(tb_list_entry_head_ref_t, tb_list_entry_ref_t node, tb_list_entry_ref_t entry)
{
    // check
