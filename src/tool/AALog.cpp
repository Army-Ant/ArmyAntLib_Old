...
namespace ArmyAnt{
    ...
    static ClassPrivateHandleManager<LoggerBase, LoggerBase_Private> sg_manager;

    const LoggerBase::Contents& LoggerBase::Contents::defaultSetting = LoggerBase::Contents();
    ...
    LoggerBase::LoggerBase() {
        sg_manager.GetHandle(this, new LoggerBase_Private());
    }

    LoggerBase::~LoggerBase() {
        auto pr = sg_manager[this];
        pr->mutex.lock();
